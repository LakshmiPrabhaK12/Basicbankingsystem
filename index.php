...
<html lang="en">
  ...
  ?>
      ...
      <!-- Introduction section -->
            <div class="row intro py-1" style="background-color: #5300C6 ">
              <div class="col-sm-12 col-md">
                <div class="heading text-center my-5">
                  
                  <h1 style="color: #FFBA37 ">SPARK BANK</h1>
      ...
      <!-- Activity section -->
            <div class="row activity text-center">
                  <div class="col-md act">
                    ...
                    <br>
                    <a href="customerlist.php"><button style="background-color : blue;">Customer List</button></a>
                  </div>
                  <div class="col-md act">
